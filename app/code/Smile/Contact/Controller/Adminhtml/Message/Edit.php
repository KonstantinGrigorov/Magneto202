...
class Edit extends \Smile\Contact\Controller\Adminhtml\Message
{
    /**
    ...
    public function __construct(
        ...
        \Smile\Contact\Api\MessageRepositoryInterface $messageRepository
    ) {
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            $this->_coreRegistry->register('smile_message', $messageModel);
        }
